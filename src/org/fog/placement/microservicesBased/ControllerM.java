...
public class ControllerM extends SimEntity {
    ...
    public ControllerM(String name, List<FogDevice> fogDevices, List<Sensor> sensors, List<Application> applications, List<String> clusterLevelIdentifier, Double clusterLatency, int placementLogic) {
        ...
        //todo should be changed based on Mohammad's implementation
    ...
    private void printQoSDetails() {
        ...
        ResultGenerator.makespanSatisfaction = successPercentage;
    }
    ...
    private void printNetworkUsageDetails() {
        ...
        ResultGenerator.networkUsage = NetworkUsageMonitor.getNetworkUsage() / Config.MAX_SIMULATION_TIME;
    }
    ...
    private void printPowerDetails() {
        ...
        ResultGenerator.powerConsumptionData = energyInfo;
