...
public class MicroserviceApp_RandomMobility_Clustering {
    ...
    public static void main(String[] args) {
        ...
        try {
             ...
             */
            MicroservicesApplication microservicesApplication = createApplication("example", broker.getId());
    ...
    private static FogDevice addMobile(String name, int userId, String appId, int parentId) {
        ...
        Sensor mobileSensor = new SensorM("sensor-" + name, "M-SENSOR", userId, appId, applications.get(0), new DeterministicDistribution(SENSOR_TRANSMISSION_TIME)); // inter-transmission time of EEG sensor follows a deterministic distribution
    ...
    private static MicroservicesApplication createApplication(String appId, int userId) {
